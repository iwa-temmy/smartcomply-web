...
const RequestDemoModal = ({ open, closeModal }) => {
  ...
  return (
    <div
      ...
      className={`${
        open ? "block translate-y-0" : "hidden translate-y-full"
      } fixed z-50 inset-0 bg-gray-900 bg-opacity-60 overflow-y-auto h-full w-full px-4 modal transition-opacity duration-100`}
    >
      <div className="relative p-4 w-full max-w-lg h-full md:h-auto mt-24 lg:mt-16 md:right-1/4 md:left-1/4 lg:right-1/3 lg:left-1/3 lg:overflow-y-scroll">
