...
export default function Nav({ styles }) {
  return (
    <header
      className={`${styles.nav} flex flex-col lg:px-20 lg:py-6 lg:flex-row lg:justify-between`}
    >
      ...
      <nav className="flex flex-col bg-slate-500 items-center lg:flex-row lg:items-center lg:bg-inherit">
        ...
        <Button name="Book Demo" styles={styles} />
      </nav>
    </header>
  );
}
