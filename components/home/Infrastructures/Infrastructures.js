      ...
      <div data-aos="fade-down">
        <div className="flex justify-between flex-col items-center md:flex-row lg:flex-row px-5">
          <div className="w-full">
            <p
              className={`${styles.infrastructure_description}  mb-8 text-2xl leading-relaxed capitalize lg:text-4xl md:w-10/12 lg:w-10/12`}
            >
              Connect Your <br /> Infrastructure and application for <br />{" "}
